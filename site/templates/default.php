<?php snippet('header') ?>
  ...
  <div class="default">
    ...
    <?php
      $teamMembers = $page->children()->visible();
    ...
    <section class="stats-bar-section">
      ...
      ?>">
        <img class="rellax bg-overlay" src="<?= $page->statBarBackgroundImage() ?>" alt="" />
            ...
            <div class="about-carousel">
              ...
              <?php 
                foreach ( $teamMembers as $teamMember ) : 
                  ...
                  $thumb = $teamMember->image()->crop(300, 300)->url();
              ?>
              <div class="item">
